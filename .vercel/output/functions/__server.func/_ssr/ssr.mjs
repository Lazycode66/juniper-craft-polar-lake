...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BeWH5udf.mjs");
...
var manifest = {
	"48b9a4cb92c2d0c22d8fc07644af6947b499fd0b4578a8e5eb0ec7a9c4e664cb": {
		functionName: "enhanceBriefing_createServerFn_handler",
		importer: () => import("./briefing-CmzW4EFf.mjs")
	},
	"7204bf98f42cc9d014f6e7d7be9dd03096e8d848ac4bf83b25eff2970c16a947": {
		functionName: "lookupIntel_createServerFn_handler",
		importer: () => import("./intel-DSVrvdEi.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D1vD6Ypz.mjs").then((n) => n.t),
